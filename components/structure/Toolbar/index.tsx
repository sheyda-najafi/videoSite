...
export default function Toolbar({ toggleMenuFunction }: ToolbarType) {
    ...
    const toolbarIconList = [
        ...
        { id: 2, icon: <ToolbarIcons.BurgerIcon onClick={() => { }} />, title: t("theme"), onClick: () => { } },
        { id: 3, icon: <ToolbarIcons.CloseIcon onClick={() => { }} />, title: t("more"), onClick: () => { } },
    ]
    ...
    return (
        <div className={`${styles.container}`}>
            <div className={`${styles.sideContainer}`}>
                ...
                <Link href="/" >  <AppImage src="/imgs/logo.svg" className={`${styles.logo}`} width={90} height={20} /></Link>
            </div>
